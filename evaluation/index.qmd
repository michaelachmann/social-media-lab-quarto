...
::: {.callout-important}
## Update 2024
* [Link to Notebook](https://colab.research.google.com/github/michaelachmann/social-media-lab/blob/main/notebooks/2023_12_14_Create_LabelStudio_Text_Evaluation.ipynb).
* Added new sources to the [recommended reading section](#recommended-reading).
* Small updates to text incorporating new sources.
:::
...
@Klie2024-kd describes a similar workflow in his dissertation, outlining an agile dataset creation process where each batch of annotated data undergoes evaluation. If the quality is adequate, the data is adjudicated; if not, measures such as revising annotations, training annotators, or refining annotation schemes or guidelines are implemented. This approach is comparable to text production workflows, although these often do not include an adjudication step [@Klie2024-kd].

![Example of an annotation workflow with multiple iterations. Source: [@Klie2024-kd].](/images/Klie-Annotation-Workflow.png){width=75%}
...
::: {.callout-note}
During the Winter 2025/26 semester, I am focusing on expanding my research on data annotation and quality management. As the semester progresses, I will update this page with insights and references from the literature listed below.
:::

* *Analyzing dataset annotation quality management in the wild.* [@Klie2024-xg]
* *Quality aspects of annotated data: A research synthesis.* [@Beck2023-eb]
* *Improving labeling through social science insights: Results and research agenda.* [@Beck2022-ng]
* *A methodology towards effective and efficient manual document annotation: Addressing annotator discrepancy and annotation quality.* [@Zhang2010-kf]
* *Measurement validity: A shared standard for qualitative and quantitative research.* [@Adcock2001-ui]
* Dissertation *Improving natural language dataset annotation quality and efficiency* [@Klie2024-kd]
