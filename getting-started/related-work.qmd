...
```{=html}
<!--![](/images/scholar-screenshot-tiktok.png){fig-alt="Screenshot of Google Scholar for the search term \"tiktok analysis\" with about 54.800 results."}
 ::: -->
```
...
| @Omena2020-jk    | Digital Methods for Hashtag Engagement Research                                                       |                                                                                                                                                                 |
| @Omena2021-gu    | The Potentials of Google Vision API-based Networks to Study Natively Digital Images                   |                                                                                                                                                                 |
