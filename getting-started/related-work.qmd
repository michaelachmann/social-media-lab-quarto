...
::: {.callout-caution}
## Work-In-Progress
As a warm-up with ChatGPT / GPT we will extract information from abstracts in our tools session. [Take a look at the notebook.](../notebooks/literature-review-v2.ipynb)
:::
