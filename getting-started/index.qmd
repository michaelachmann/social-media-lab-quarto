...
|  23.10.23  | [Introduction to Social Media Analysis](theory.qmd) |
|  30.10.23  | Projects &amp; Groups, <br/> [Getting Started: Tools](tools.qmd)                                 |
...
* We will explore different tools to visualize images:
 ...
 + [Memespector](https://github.com/jason-chao/memespector-gui) and [Gephi](https://gephi.org/)^[following Omena's concept for cloud vision labels, see [related work]().]
