...
Exploring image corpora using labels or web-entities is just one way of using commercial APIs. Several providers offer models for text detection (OCR), face detection, and more. [Below](#image-captions) we will take a look at auto-generated image captions -- which coincidentally produce text, a data format compatible for [exploration](../processing/exploration.qmd) and [classification](../processing/classification.qmd) using methods established in past sessions.



### BERTopic
{{< embed ../notebooks/2024_01_12_Visual_BERTopic_Bauernproteste.ipynb >}}
...
I introduced several approaches to explore collections of visual (social media) data. 